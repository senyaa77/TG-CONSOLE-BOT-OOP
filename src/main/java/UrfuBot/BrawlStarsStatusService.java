...
public class BrawlStarsStatusService {
    private static final String STATUS_URL = "https://brawlstars.statuspage.io/api/v2/summary.json";
    ...
    public static String getBrawlStarsStatus() {
        try {
            ...
            return "❌ Ошибка получения статуса Brawl Stars.";
        }
    }
}
